...
public class NormalStringPool {
    ...
    public static void onDebugList(RenderGameOverlayEvent.Text event) {
        ...
        if (minecraft.gameSettings.showDebugInfo) {
            ...
            list.add(String.format("%s%s%s: %s strings processed. %s unique, %s deduplicated.", TextFormatting.AQUA, "<FermiumASM>", TextFormatting.RESET, deduplicatedCount, size, deduplicatedCount - size));
        }
    }
